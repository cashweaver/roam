...
Psychophysiologic Symptom Relief Therapy (PSRT) is a program for pain relief first^{?} detailed in [[https://journals.lww.com/painrpts/fulltext/2021/09000/psychophysiologic_symptom_relief_therapy_for.13.aspx][Donnino et al.]] and makes use of [[id:92eb61e0-5437-4fbf-80aa-d042c0ba6d1e][Mindfulness-based Stress Reduction]]

* Components of the Psychophysiologic Symptom Relief Therapy (PSRT) program
:PROPERTIES:
...
* TODO Convert link to use =org-cite=
